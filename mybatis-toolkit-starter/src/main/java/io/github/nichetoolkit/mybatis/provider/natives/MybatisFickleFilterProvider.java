...
/**
 * <code>MybatisFickleFilterProvider</code>
 * <p>The mybatis fickle filter provider class.</p>
...
@Slf4j
@Component
public class MybatisFickleFilterProvider implements MybatisSqlProvider {
    @Override
     ...
     * @return {@link java.lang.String} <p>The find dynamic all by fickle load where return object is <code>String</code> type.</p>
