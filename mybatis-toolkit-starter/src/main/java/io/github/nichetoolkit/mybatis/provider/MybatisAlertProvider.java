...
public class MybatisAlertProvider implements MybatisSqlProvider {
     ...
     */
    public static <I, S> String alertDynamicById(ProviderContext providerContext, String tableName, I id, S status, String statusName) throws RestException {
        ...
        return MybatisSqlProvider.providingOfId(providerContext, tableName, id, status, statusName,ALERT_SQL_SUPPLY);
    }
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    public static <I, S> String alertDynamicAll(ProviderContext providerContext, String tableName, Collection<I> idList, S status, String statusName) throws RestException {
        ...
        return MybatisSqlProvider.providingOfAll(providerContext, tableName, idList, status,  statusName,ALERT_SQL_SUPPLY);
    }
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    public static <I, S> String alertDynamicAllByWhere(ProviderContext providerContext, String tableName, String whereSql, S status, String statusName) throws RestException {
        ...
        return MybatisSqlProvider.providingOfWhere(providerContext, tableName, whereSql, status, statusName, ALERT_SQL_SUPPLY);
    }
