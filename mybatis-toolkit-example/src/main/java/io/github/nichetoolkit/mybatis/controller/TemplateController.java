...
public class TemplateController {
     ...
     * @param templateModel {@link io.github.nichetoolkit.mybatis.test.template.TemplateModel} <p>The template model parameter is <code>TemplateModel</code> type.</p>
     ...
     * @see io.github.nichetoolkit.mybatis.test.template.TemplateModel
     ...
     * @param filter {@link io.github.nichetoolkit.mybatis.test.template.TemplateFilter} <p>The filter parameter is <code>TemplateFilter</code> type.</p>
     * @return {@link io.github.nichetoolkit.rest.RestResult} <p>The query by filter return object is <code>RestResult</code> type.</p>
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     * @see io.github.nichetoolkit.mybatis.test.template.TemplateFilter
     * @see org.springframework.web.bind.annotation.RequestBody
     * @see io.github.nichetoolkit.rest.RestResult
     * @see org.springframework.web.bind.annotation.PostMapping
     * @see io.github.nichetoolkit.rest.RestException
