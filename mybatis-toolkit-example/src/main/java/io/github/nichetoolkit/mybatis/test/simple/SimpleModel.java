...
public class SimpleModel extends RestInfoModel<SimpleModel,SimpleEntity> implements RestTablekey<String> {
    ...
    /**
     * <code>status</code>
     * {@link SimpleStatus} <p>The <code>status</code> field.</p>
     * @see  SimpleStatus
     */
     ...
     * <code>SimpleModel</code>
     * <p>Instantiates a new simple model.</p>
     * @param builder {@link SimpleModel.Builder} <p>The builder parameter is <code>Builder</code> type.</p>
     * @see  SimpleModel.Builder
     */
    ...
    public static class Builder extends RestInfoModel.Builder<SimpleModel,SimpleEntity> {
         ...
         * @see  java.lang.Long
         * @return  {@link SimpleModel.Builder} <p>The time return object is <code>Builder</code> type.</p>
         */
