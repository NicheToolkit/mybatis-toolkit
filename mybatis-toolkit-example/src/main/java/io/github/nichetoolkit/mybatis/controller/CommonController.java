...
public class CommonController {
     ...
     * @param commonModel {@link io.github.nichetoolkit.mybatis.test.common.CommonModel} <p>The common model parameter is <code>CommonModel</code> type.</p>
     ...
     * @see io.github.nichetoolkit.mybatis.test.common.CommonModel
     ...
     * @param filter {@link io.github.nichetoolkit.mybatis.test.common.CommonFilter} <p>The filter parameter is <code>CommonFilter</code> type.</p>
     * @return {@link io.github.nichetoolkit.rest.RestResult} <p>The query by filter return object is <code>RestResult</code> type.</p>
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     * @see io.github.nichetoolkit.mybatis.test.common.CommonFilter
     * @see org.springframework.web.bind.annotation.RequestBody
     * @see io.github.nichetoolkit.rest.RestResult
     * @see org.springframework.web.bind.annotation.PostMapping
     * @see io.github.nichetoolkit.rest.RestException
